...
# main.c uses the tone library at buttonlib.h and buttonlib.c

# Bowei Zhang, 2012

# compiling tonelib.c into tonelib.out
avr-gcc -DF_CPU=16000000UL -mmcu=atmega328p -c buttonlib.c
avr-gcc -DF_CPU=16000000UL -mmcu=atmega328p -c tonelib.c

# compiling main.c into main.out
avr-gcc -DF_CPU=16000000UL -mmcu=atmega328p -c main.c

# linking main.out and tonelib.out
avr-gcc -DF_CPU=16000000UL -mmcu=atmega328p buttonlib.o tonelib.o main.o -o main
